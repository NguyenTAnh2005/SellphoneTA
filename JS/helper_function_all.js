function getHtml_header(level) {
    ...
    return `
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <form role="search" class="d-flex mt-2 mt-xl-0 ">
                    <input type="search" id="search" class="form-control me-2 rounded-pill" placeholder="searching here">
...
export function addProductToList(id_list, arr_product) {
    ...
    arr_product.forEach(item => {
        list_html.innerHTML += `
        <div class="col mt-4" >
                <div class="card pt-2 px-2 border-2 border-danger rounded-4 mx-auto" style="max-width:45vw" id="product_item">
                    ...
                    <div class="card-body pb-0">
                        ...
                        <a class="text-decoration-none text-danger mt-0 d-flex justify-content-center" href="second_page/product_detail.html">
                            <button class="btn btn-danger px-2 py-0 rounded-4 d-flex align-items-center" style="transform:translateY(50%)">
                                See more
